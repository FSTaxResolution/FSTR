...
{Array.from({ length: 10 }, (_, i) => i + 1).map((n) => (
        ...
        <button
          type="submit"
          className="flex w-full items-center justify-between bg-lime px-6 py-4 text-sm font-semibold uppercase tracking-widest text-midnight transition-colors duration-200 hover:bg-lime/90"
        >
